...
ggsave("tex/figuras/mapa-lotes.pdf", gg, height = 10, width = 10)
ggsave("tex/figuras/mapa-lotes-metro.pdf", height = 10, width = 10,
       plot = gg +   
...
ggsave("tex/figuras/event-study.pdf", width = 8, height = 6)
```
