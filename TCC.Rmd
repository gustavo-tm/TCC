...
modelsummary(list(
  ...
  tab_caption("Resultado diff-in-diff do Censo, para setores censitários em um raio de 150m dos eixos") |> 
...
#antes do tratamento no grupo tratamento
(0.054 -0.003)
...
gg <- df.censo |> 
  ...
  (\(df, start_roll = 150, end_roll = 40, step = 5) {
