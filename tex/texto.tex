...
\begin{figure}[!h]
    ...
    \includegraphics[width = .85\textwidth]{figuras/rdd-balanceamento-censo.pdf}
...
\begin{equation}
    Y = \beta_0 + \beta_1P + \beta_2T + \beta_3Q + \beta_4PT + \beta_5PQ + \beta_6TQ + \beta_7PQT
\end{equation}

\begin{align}
    &\frac{\partial E(Y|T=t,P=p,Q=0)}{\partial T} = \beta_2 + \beta_4p\\
    &E(Y|T=1,P=1,Q=0) - E(Y|T=1,P=0,Q=0)= \beta_4\\\notag\\\notag\\
    &\frac{\partial E(Y|T=t,P=p,Q=q)}{\partial T} = \beta_2 + \beta_4p + \beta_6q + \beta_7pq\\
    &[E(Y|T=1,P=1,Q=q) - E(Y|T=1,P=0,Q=q)]= \beta_4 + \beta_7q
\end{align}



\input{tabelas/did-censo-interpret.tex}
