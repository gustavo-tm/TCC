...
df.censo <- censo.distancias |>
  ...
  select(id_setor, ano, distancia, grupo, starts_with("densidade"), area_residencial_novo_percent)
...
gg <- ggplot() +
  ...
  theme_void() +
   scale_fill_manual(values = c("Outros" = "lightgrey",
...
bind_rows(
  ...
  scale_colour_manual(name = "",
                      ...
                      labels = c("TRUE" = "Residencial", "FALSE" = "Não Residencial")) +
