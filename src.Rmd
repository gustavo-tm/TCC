...
censo2010 <- read_sf("dados/censo/2010/35SEE250GC_SIR.shp") |> 
  ...
  left_join(readxl::read_excel("dados/censo/2010/Basico_SP1.XLS") |> 
            ...
            by = join_by(id_setor)) |> 
  filter(st_covered_by(st_centroid(geometry), eixos.buffersimples |> st_buffer(-100)) |> as.logical()) |> 
  mutate(ano = 2010)
...
censo <- censo.areas |> 
  ...
  select(id_setor, ano, moradores, area_lote, area_residencial, area_residencial_novo_percent, geometry)

saveRDS(censo, "rdata/censo-areas.rds")
